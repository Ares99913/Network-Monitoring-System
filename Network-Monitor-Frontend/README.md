...
Navigate using the application menu
Access the dashboard for an overview of network status
Use specific monitoring pages to track devices, networks, and system performance
Features by Page
Dashboard
